defmodule Bonfire.Web.Endpoint do
  ...
  def include_assets(conn) do
    ...
    if Bonfire.Common.Config.get!(:env) == :dev do
      "<link phx-track-static rel='stylesheet' href='"<> static_path("/css/app.css") <>"'/> <script defer phx-track-static type='module' src='"<> js <>"'></script> <link rel='modulepreload' href='"<> static_path("/js/vendor.js") <>"'/>"
    else
      "<link phx-track-static rel='stylesheet' href='"<> static_path("/css/app.css") <>"'/> <script defer phx-track-static type='module' src='"<> js <>"'></script> <link rel='modulepreload' href='"<> static_path("/js/vendor.js") <>"'/> "
    end
  end
